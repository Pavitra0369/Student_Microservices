...
public class RatingController {
	...
	@GetMapping("/ratings/{collegeId}")
	public ResponseEntity<List<Rating>> getRatingByCollegeId(@PathVariable Integer collegeId){
		List<Rating> ratingByCollegeId = ratingService.getRatingByCollegeId(collegeId);
		return ResponseEntity.ok(ratingByCollegeId);
	}
}
